function showDeleteModal(supplierId, status) {
    try {
        if (status != '1') {
            Swal.fire({
                title: 'Error!!',
                html: 'To delete a supplier, they must first be active.',
                icon: 'error',
        ...
        $('#tbSuppliers').DataTable({
            ...
            "columns": [
                ...
                },
                {
                    ...
                    "render": function(data, type, row) {
                        return `
                            <button type="button" class="btn btn-secondary btn-icon waves-effect waves-light mx-1" onclick="window.location.href='/supplier/detail?id=${data}'" title="View"><i class="ri-eye-fill"></i></button>
                            <button type="button" class="btn btn-primary btn-icon waves-effect waves-light mx-1" onclick="window.location.href='/supplier/update?id=${data}'" title="Update"><i class="ri-pencil-fill"></i></button>
